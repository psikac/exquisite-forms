        ...
        <div>
            <form action={onSubmit} className="flex flex-col gap-5">
                <div className="text-center flex flex-col gap-2 items-center">
                    ...
                    <input type="number" name="numberLength" id="numberLength" min={MIN_NUMBER_LENGTH} max={MAX_NUMBER_LENGTH} defaultValue={DEFAULT_NUMBER_LENGTH} onChange={(e) => handleNumberChange(e)}/>
                ...
                <div className="flex gap-5 justify-center">
                    ...
                    <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-md w-[75px]" type="button" onClick={() => handleNoClick()}>No</button>
